...
const categoryRules: { pattern: RegExp; category: string; title: (slug: string) => string }[] = [
  ...
  { pattern: /^plise-perde$|^honeycomb-perde$|^duet-perde$|^plise-perde-aparatlari$|^plise-perde-yedek-parca$|^plise-perde-katalog$|^plise-perde-renkleri$/, category: "Ürünlerimiz", title: (s) => titleFromSlug(s) },
  { pattern: /^plise-perde-modelleri$/, category: "Modellerimiz", title: () => "Modellerimiz" },
  { pattern: /^duz-plise-perde$|^blackout-plise-perde$|^gece-gunduz-plise-perde$|^desenli-plise-perde$|^baskili-plise-perde$|^plise-perde-sineklik$/, category: "Modellerimiz", title: (s) => titleFromSlug(s) },
  { pattern: /^plise-perde-sistemleri$/, category: "Sistemlerimiz", title: () => "Sistemlerimiz" },
  { pattern: /^yatay-plise-perde$|^dikey-plise-perde$|^tavan-plise-perde$|^kasali-plise-perde$|^ucgen-plise-perde$|^egimli-plise-perde$|^acili-plise-perde$|^yuvarlak-plise-perde$|^oval-plise-perde$|^cift-cam-arasi-plise-perde$/, category: "Sistemlerimiz", title: (s) => titleFromSlug(s) },
  { pattern: /^plise-perde-montaji$/, category: "Plise Perde Montajı", title: () => "Plise Perde Montajı" },
  { pattern: /^vidali-plise-perde$|^yapiskanli-plise-perde$|^kancali-plise-perde$|^portrayli-plise-perde$|^braketli-plise-perde$|^motorlu-plise-perde$/, category: "Plise Perde Montajı", title: (s) => titleFromSlug(s) },
...
const slugTitleMap: Record<string, string> = {
  ...
  "plise-perde-montaji": "Plise Perde Montajı",
  "plise-perde-katalog": "Plise Perde Katalog",
  "plise-perde-renkleri": "Plise Perde Renkleri",
  "plise-perde-sineklik": "Plise Perde + Sineklik",
  "yatay-plise-perde": "Yatay Plise Perde",
  "dikey-plise-perde": "Dikey Plise Perde",
  "tavan-plise-perde": "Tavan Plise Perde",
  "kasali-plise-perde": "Kasalı Plise Perde",
  "ucgen-plise-perde": "Üçgen Plise Perde",
  "egimli-plise-perde": "Eğimli Plise Perde",
  "acili-plise-perde": "Açılı Plise Perde",
  "yuvarlak-plise-perde": "Yuvarlak Plise Perde",
  "oval-plise-perde": "Oval Plise Perde",
  "cift-cam-arasi-plise-perde": "Çift Cam Arası Plise Perde",
  ...
  "plise-perde-vs-dikey-perde": "Plise Perde vs Dikey Perde",
  "plise-perde-vs-duet-perde": "Plise Perde vs Düet Perde",
  "plise-perde-vs-fon-perde": "Plise Perde vs Fon Perde",
  "plise-perde-vs-honeycomb-perde": "Plise Perde vs Honeycomb Perde",
  "plise-perde-vs-japon-perde": "Plise Perde vs Japon Perde",
  "plise-perde-vs-karartma-perde": "Plise Perde vs Karartma Perde",
  "plise-perde-vs-screen-perde": "Plise Perde vs Screen Perde",
  "plise-perde-vs-zip-perde": "Plise Perde vs Zip Perde",
  "plise-perde-yedek-parca": "Plise Perde Yedek Parça",
  "portrayli-plise-perde": "Portrayli Plise Perde",
