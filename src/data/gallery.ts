...
export const galleryCategories: GalleryCategory[] = [
  ...
  },
  {
    ...
    images: [
      { src: "/gallery/duet-perde/Duet-Perde-1.webp", alt: "Düet perde salon uygulaması — üst tül alt blackout kombinasyonu", caption: "Salon — Düet Perde", description: "Salonda düet perde uygulaması, üst tül alt blackout ile gece gündüz esnek kullanım", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-2.webp", alt: "Düet perde yatak odası uygulaması — gece gündüz blackout model", caption: "Yatak Odası — Düet Perde", description: "Yatak odasında düet perde, alt blackout ile tam karartma üst tül ile doğal aydınlatma", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-3.webp", alt: "Düet perde cam balkon uygulaması — tül blackout kombinasyonu", caption: "Cam Balkon — Düet Perde", description: "Cam balkonda düet perde, az yer kaplayan yapı ile esnek ışık kontrolü", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-4.webp", alt: "Düet perde mutfak uygulaması — tül model doğal aydınlatma", caption: "Mutfak — Düet Perde", description: "Mutfakta düet perde, üst tül ile doğal aydınlatma alt blackout ile istenirse karartma", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-5.webp", alt: "Düet perde ofis uygulaması — profesyonel tül blackout model", caption: "Ofis — Düet Perde", description: "Ofis ortamında düet perde, toplantı ve çalışma için esnek aydınlatma kontrolü", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-6.webp", alt: "Düet perde salon — geniş pencere uygulaması", caption: "Salon — Geniş Pencere Düet Perde", description: "Geniş salon penceresinde düet perde, simetrik montaj ile bütüncül görünüm", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-7.webp", alt: "Düet perde yatak odası — krem renk düet model", caption: "Yatak Odası — Krem Düet Perde", description: "Yatak odasında krem renk düet perde, sıcak görünüm ve esnek ışık kontrolü", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-8.webp", alt: "Düet perde detay görünümü — tül blackout kumaş close-up", caption: "Düet Perde — Detay Görünüm", description: "Düet perde tül ve blackout kumaş detayı, çift kumaş kombinasyonunun görünümü", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-9.webp", alt: "Düet perde villa uygulaması — yüksek pencere düet model", caption: "Villa — Düet Perde", description: "Villada yüksek pencere düet perde, motorlu seçenek ile konforlu kullanım", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-10.webp", alt: "Düet perde kış bahçesi uygulaması — esnek ışık kontrolü", caption: "Kış Bahçesi — Düet Perde", description: "Kış bahçesinde düet perde, mevsim boyu esnek aydınlatma için ideal çözüm", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-11.webp", alt: "Düet perde çalışma odası — tül blackout odaklanma için", caption: "Çalışma Odası — Düet Perde", description: "Çalışma odasında düet perde, blackout ile projeksiyon tül ile doğal ışık", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-12.webp", alt: "Düet perde salon — antrasit renk düet uygulaması", caption: "Salon — Antrasit Düet Perde", description: "Salonda antrasit renk düet perde, modern görünüm ve esnek kullanım", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-13.webp", alt: "Düet perde çocuk odası — kordsuz güvenli düet model", caption: "Çocuk Odası — Düet Perde", description: "Çocuk odasında düet perde, kordsuz yapı ile güvenli ve esnek kullanım", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-14.webp", alt: "Düet perde banyo uygulaması — nem dayanımlı düet model", caption: "Banyo — Düet Perde", description: "Banyoda nem dayanımlı düet perde, pratik kullanım ve estetik görünüm", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-15.webp", alt: "Düet perde fransız balkon — az yer kaplayan düet model", caption: "Fransız Balkon — Düet Perde", description: "Fransız balkonda düet perde, dar alanlar için ideal az yer kaplayan çözüm", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-16.webp", alt: "Düet perde salon — çift pencere düet perde uygulaması", caption: "Salon — Çift Pencere Düet Perde", description: "Salonda çift pencerede düet perde, simetrik montaj ile bütüncül görünüm", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-17.webp", alt: "Düet perde yatak odası — gece gündüz esnek kullanım", caption: "Yatak Odası — Gece Gündüz Düet Perde", description: "Yatak odasında düet perde, gündüz tül gece blackout ile esnek kullanım", width: 1400, height: 1400 },
      { src: "/gallery/duet-perde/Duet-Perde-18.webp", alt: "Düet perde ofis — toplantı odası düet perde uygulaması", caption: "Ofis — Toplantı Odası Düet Perde", description: "Toplantı odasında düet perde, projeksiyon için blackout ve doğal ışık için tül", width: 1400, height: 1400 },
    ],
  },
];
