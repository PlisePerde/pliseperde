      ...
      <div className="bg-brand-text text-white">
        <div className="px-4 md:px-6 h-8 flex items-center justify-between text-xs relative">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <div className="hidden sm:block h-3 w-px bg-white/30" />
            <a href={siteConfig.social.facebook} target="_blank" rel="nofollow noopener noreferrer" aria-label="Facebook" className="text-white/80 hover:text-white transition-colors touch-reset">
            ...
            <a href={siteConfig.social.instagram} target="_blank" rel="nofollow noopener noreferrer" aria-label="Instagram" className="text-white/80 hover:text-white transition-colors touch-reset">
            ...
            <a href={siteConfig.social.youtube} target="_blank" rel="nofollow noopener noreferrer" aria-label="YouTube" className="text-white/80 hover:text-white transition-colors touch-reset">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
            </a>
            <a href={siteConfig.social.pinterest} target="_blank" rel="nofollow noopener noreferrer" aria-label="Pinterest" className="text-white/80 hover:text-white transition-colors touch-reset">
            ...
            <a href={siteConfig.social.linkedin} target="_blank" rel="nofollow noopener noreferrer" aria-label="LinkedIn" className="text-white/80 hover:text-white transition-colors touch-reset">
