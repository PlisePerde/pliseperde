...
const independentCategories: MainCategory[] = [
  {
    ...
    description: "Tüm plise perde model seçenekleri: düz, blackout, gece gündüz, desenli, baskılı, sineklik.",
    subItems: [
      ...
      { name: "Plise Perde + Sineklik", url: "/plise-perde-sineklik/" },
    ],
  },
  {
    name: "Plise Perde Sistemleri",
    url: "/plise-perde-sistemleri/",
    description: "Uygulama yüzeyi ve formuna göre plise perde sistemleri: yatay, dikey, tavan, kasalı, üçgen, eğimli, açılı, yuvarlak, oval, çift cam arası.",
    subItems: [
      { name: "Yatay Plise Perde", url: "/yatay-plise-perde/" },
      { name: "Dikey Plise Perde", url: "/dikey-plise-perde/" },
      { name: "Tavan Plise Perde", url: "/tavan-plise-perde/" },
      { name: "Kasalı Plise Perde", url: "/kasali-plise-perde/" },
      { name: "Üçgen Plise Perde", url: "/ucgen-plise-perde/" },
      { name: "Eğimli Plise Perde", url: "/egimli-plise-perde/" },
      { name: "Açılı Plise Perde", url: "/acili-plise-perde/" },
      { name: "Yuvarlak Plise Perde", url: "/yuvarlak-plise-perde/" },
      { name: "Oval Plise Perde", url: "/oval-plise-perde/" },
      { name: "Çift Cam Arası Plise Perde", url: "/cift-cam-arasi-plise-perde/" },
    ],
  },
  {
    ...
    subItems: [
      ...
      { name: "Portrayli Plise Perde", url: "/portrayli-plise-perde/" },
