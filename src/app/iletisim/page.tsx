              ...
              <div className="grid grid-cols-2 gap-3 mb-3">
                ...
                <div className="p-3.5 border border-brand-border rounded-lg flex items-center gap-3 hover:bg-brand/5 hover:border-brand transition-colors group">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <a href="https://tawk.to/pliseperde/" target="_blank" rel="noopener noreferrer" className="touch-reset block text-sm text-brand-text-light hover:text-brand transition-colors m-0 leading-snug whitespace-nowrap">
                      Sohbet Başlat!
                    </a>
                  </div>
                </div>
